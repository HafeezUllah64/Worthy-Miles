...
//                    duration: Duration(milliseconds: 1000),
  ...
  Widget _buildButton() {
    return RawMaterialButton(
      ...
      onPressed: () {
        print("PAGE NO : ${_pageController.page}\nColors length : ${widget.colors.length}");
        if (_pageController.page == widget.colors.length - 1 || _pageController.page > widget.colors.length - 1 ) {
