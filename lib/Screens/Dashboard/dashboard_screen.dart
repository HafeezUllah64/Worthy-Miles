...
class _DashboardScreenState extends State<DashboardScreen> {
  List<String> days = ["Today", "Week", "Month", "Year"];
      ...
      child: Row(
        ...
        children: days.map((e) {
          ...
          return InkWell(
            ...
            child: Text(e, style: e == selectedDay ? CustomTextStyle.dayTabBarStyleActive : CustomTextStyle.dayTabBarStyleInactive,),
          );
        }).toList(),
